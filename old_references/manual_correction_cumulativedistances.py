...
def interactive_error_correction(
    ...
    # Iterate through all surveys to show a plot tracking progress with tqdm
    for fid in tqdm(df['file_id'].unique(), desc="Messfahrten"): # iterate through each individual survey by file_id
        ...
        pts_all = []  # prepare list of all points and their specific informations [Distance, depth, index, original color]
        ...
        def onselect(eclick, erelease): # cklick contains coordinate of click start - erelease coordinates of cklick release
